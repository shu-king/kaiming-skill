...
- **04-themes.md** (or verbatim-corpus.md) — 519 collected quotes organized by theme (simplicity, residual, self-supervision, deconstruction, scaling, generality, ablation-discipline, pixels-over-tokens, recognition-generation-duality). Use to find additional illustrative quotes for any paper listed above.
...
- **SKILL.md** — The master skill document. The reading priority list in this file maps directly onto SKILL.md's "core commitments" section.

---

## Conventions

- Quotes are sourced from `notes/{id}.json`; run `scripts/verify_quotes.py` before making exact-verification claims.
